...
- **Pi/FirstMate:** Pi is Main. `kimiflow_crew` delegates confirmed work; FirstMate owns workers. Workers use brief/status, not user dialogue or another Active Run.
