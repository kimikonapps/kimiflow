...
- **FirstMate boundary:** its primary owns dialogue/confirmed contract. Crewmates use the plan brief as intake/status. Kimiflow owns no Pi/Herdr lifecycle or Active Run.
