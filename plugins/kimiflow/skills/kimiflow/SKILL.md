...
- Phase-7 Review Ensemble runs every axis once per stable PLAN, then required repair deltas. Schema-3 materiality allows only promoted repairs; protected impacts cannot be waived. Stable classes and the absolute three-round-plus-closeout cap stop ping-pong.
