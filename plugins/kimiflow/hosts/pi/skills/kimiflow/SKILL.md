---
name: kimiflow
description: "Minimal delivery support in Pi with the selected model and native tools; no crew, provider routing or workflow controller."
---

# Kimiflow for Pi

Read `SKILL.md` at the installed package root once and use its working agreement. Keep the selected
