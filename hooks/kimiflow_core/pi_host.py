...
def _workflow_prompt(payload, environ=None, verbosity=None):
    ...
    return (
        ...
        "discovery shell, inspect process environment, or query Git history. "
        ...
        "document specifies. The read-only Phase-1 intent critic and bounded "
        "Phase-2 research worker may be called before the final contract. Phase "
        "gates require the resulting mechanical receipt.\n"
        "%s\n\n"
        "Transport request:\n%s"
        % (
            plugin_root,
