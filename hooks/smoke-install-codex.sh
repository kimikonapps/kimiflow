...
grep -q 'Contract-4 concrete Product Intake with Contract-3 resume compatibility' "$ROOT/SKILL.md" && ok "canonical skill requires bounded intent interaction" || bad "canonical skill missing bounded intent interaction"
