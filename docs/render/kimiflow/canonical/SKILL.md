...
- **Local security:** **`kimiflow security scan <path>`** / **`kimiflow security diff <path>`** writes private, local, model-free evidence; `accept|close` uses a normal fix child. → reference.md "Local actionable security".
