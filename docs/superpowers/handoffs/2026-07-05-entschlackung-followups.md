...
- **E ENTSCHIEDEN** (User, 05.07.): Option 1 — GSD + Superpowers deinstallieren, kimiflow wird die einzige Prozess-Spur. Umsetzung als separater Auftrag im `~/.claude`-Kontext, noch offen.
